...
def npu_format_cast(
    ...
    if tensor.device == torch.device("cpu"):
        logger.info("Warning: The conversion from ND to NZ does not work on the CPU, 
        please disable offloading, otherwise the performance will be significantly reduced.")
    else:
